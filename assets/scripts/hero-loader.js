      ...
      request.done(function (data) {
        ...
        collapse.then(function () {
          ...
          if (gamePatch != _this.patch) {
            $frame.prepend('<span class="patch patch-outdated"><img class="patch-img" src="https://howdoiplay.com/assets/media/patches/patchbetablank.png"><div class="patch-text">not yet ' + gamePatch + '\'d</div></span>');
          } else {
